...
# ==========================================
NEW_SHEET_URL = "https://docs.google.com/spreadsheets/d/1hHMSBt89Q22v0lO3mJmHsMEDTbZAXdlsaXNPsGkrP58/edit?gid=1353387727#gid=1353387727" # <-- ใส่ลิงก์ Google Sheet ใหม่ที่นี่ (ถ้าไม่ได้ตั้งไว้ใน .env)
SHEET_TAB_NAME = "CONDO @ Bearing - Bangna" # <-- เปลี่ยนเป็นชื่อแท็บที่ต้องการ เช่น 'ข้อมูลใหม่'
