...
class EvaluatorAgent:
    ...
    def evaluate_listing(self, parsed_data):
        ...
        8. "floor": จำนวนชั้น/ชั้นที่ตั้ง ถ้าประกาศเป็น "บ้าน" ให้หาว่าบ้านมีจำนวนกี่ชั้น (เช่น "2 ชั้น", "3 ชั้น") และนำมาตอบ แต่ถ้าเป็นคอนโดหรือห้องชุด ให้พยายามหาว่าอยู่ชั้นที่เท่าไหร่ (เช่น "ชั้น 3")
        9. "type": ระบุว่าเป็นการ "ขาย" หรือ "เช่า" หรือ "ขายและเช่า"
        10. "size": ขนาดพื้นที่ (ตัวเลขเท่านั้น เช่น 30)
